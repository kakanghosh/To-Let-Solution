...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href= "../../css/admin_profile_design.css" />
	...
	<?php
		if(isset($_SESSION["USERID"]) && $_SESSION["USERTYPE"]){
			...
			if($_SESSION["USERTYPE"] == 'ADMIN_USER'){
				echo '<a href = "admin_profile.php" id = "profile"> Profile </a>'.'&nbsp;&nbsp;&nbsp';
			}else{
	...
	?>
		...
		<form method = "POST" action = "admin_profile.php" enctype = "multipart/form-data" id = "pic_form" >
			<input type="file" id = "imageFileUploader"  name = "propic">
			<input type="submit" onclick = "return pictureUpload()" value = "Change Image" name = "pic_choose_btn" />
		</form>
	...
	<form action = "admin_profile.php" method="post" id = "changePassForm">
		...
		<input type = "submit" onclick = "return passChange()" value = "Chanage Password" name = "passwordChangeButton" />
