...
<html>
	...
	<body>
		<?php
			...
			$areaArray = array('Uttora','Farmgate','Mirpur','Gulsan','Banani','Mogh Bazar','Nikunjo-1',
			'Nikunjo-2','Basundhara','Gulistan','Badda','Puran Dhaka','Mouchak','Malibag','Shymoli','Niketon','Mohakhali','Agargao','Dhanmondi');
	...
	*/
	if( isset($_POST["post_button"]) ){
		...
		$place = $_POST["adress"].",".$_POST["area"].",".$_POST["city"]."."; 
		$rent = $_POST["rentText"];
	...
	if($_SESSION["USERTYPE"] == "ADMIN_USER"){
		...
		echo '<Button id = "ad_new_post" onclick = "admin_new_post()" style= "cursor:pointer"> Add New post </Button>
	...
	<!-- New Post FORM Div starts here -->
		<div id = 'post_ad' style = 'display:none;'>	
			...
			<form method = "POST" action = "post.php" name = "new_post_form" enctype ="multipart/form-data">	
				...
				Adreess: <input type = "text" name = "adress" placeholder = "Type your adress"><br><br>
				Select City : &nbsp 
				<select name = "city">
