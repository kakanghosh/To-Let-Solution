...
<html>
	<head>
		<title> Search and find your dream rent house </title>
	...
	<?php
		...
		<!-- Search option  start here-->
			<!-- Search Feature will be done here -->
				...
				<?php
				echo "<a href = 'user/user_login.php' id='account_a' > Have Account? Login  </a> ";
				echo space(10)."<a href = 'user/user_registration.php' id='regi_a'> Want to Post Ad? Open New Account </a>";
			?>	
			<!-- Search feature ends here-->
		<!-- -->
	<?php	
