	...
	function firstNameValidation(e){
		...
		if(e.value.length < 1){
			document.getElementById('submitButton').style.background= '#ff1744';
	...
	function passwordValidation( ){
		...
		if(document.getElementById("password").value.length < 1 && document.getElementById("repassword").value.length < 1){
			...
			document.getElementById('notice_icon_6').style.visibility = "hidden";
			document.getElementById('submitButton').style.background= '#ff1744';	
			...
			document.getElementById('notice_icon_6').style.visibility = "visible";
			document.getElementById('paserror').innerHTML = '';
			
			if(  document.getElementById("password").value == document.getElementById("repassword").value ){
				document.getElementById('repaserror').innerHTML = '';	
				document.getElementById('notice_icon_5').src = "../website_icon/tick_correct.png"; 
				document.getElementById('notice_icon_6').src = "../website_icon/tick_correct.png"; 	
				pass = true;
				repass = true;
				if(isValid()){
					document.getElementById("submitButton").disabled = false;
				...
				document.getElementById('notice_icon_6').src = "../website_icon/cross.png";
				repass = false;
				pass = false;
				document.getElementById("submitButton").disabled = true;
				document.getElementById('submitButton').style.background= '#ff1744';
